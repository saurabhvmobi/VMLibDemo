...
spec.homepage = "https://github.com/saurabhvmobi/Library.git"
...
spec.source = { git: "https://github.com/saurabhvmobi/Library.git", tag: "v#{spec.version}", submodules: true }
spec.source_files = "Library/**/*.{h,swift}"
